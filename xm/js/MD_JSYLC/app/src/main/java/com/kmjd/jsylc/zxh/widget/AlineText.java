...
/**
 * Created by 80621 on 2018/8/10.
 */

@SuppressLint("AppCompatCustomView")
public class AlineText extends TextView {
    private int mLineY = 0;//总行高
    private int mViewWidth;//TextView的总宽度
    private TextPaint paint;

    public AlineText(Context context) {
        super(context);
        init();
    }

    public AlineText(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public AlineText(Context context, AttributeSet attrs, int defStyleAttr) {
