...
public class SelfBar extends RelativeLayout implements View.OnClickListener {
    ...
    public SelfBar(Context context) {
        this(context,null);
    }

    public SelfBar(Context context, AttributeSet attrs) {
        this(context, attrs,0);
    }

    public SelfBar(Context context, AttributeSet attrs, int defStyleAttr) {
...
//        initTwoType(context, attrs);//第二种初始化
    ...
    private void iniView(Context context) {
        View view = LayoutInflater.from(context).inflate(R.layout.custom_self_bar, this, true);
